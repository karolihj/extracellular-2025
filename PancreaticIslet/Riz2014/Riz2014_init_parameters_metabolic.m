function [parameters, varargout] = Riz2014_init_parameters_metabolic()
  % % Default parameter values for ODE model: Riz2014 metabolig version
  % % -----------------------------------------------
  % %
  % % parameters = Riz2014_init_parameters_metabolic();
  % % [parameters, parameters_names] = Riz2014_init_parameter_metabolic();
